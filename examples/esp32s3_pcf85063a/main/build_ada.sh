#!/bin/bash
# Build the PCF85063A-demo Ada (pcf85063a.gpr) against the PINNED crate runtime into
...
EX="$(cd "$HERE/.." && pwd)"                 # examples/esp32s3_pcf85063a/
...
( cd "$EX" && gprbuild -p -P pcf85063a.gpr )
