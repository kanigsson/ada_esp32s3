...
procedure Main is
   ...
   K1 : constant Key_Bytes (0 .. 15) :=
     (16#25#, 16#5D#, 16#3F#, 16#D9#, 16#57#, 16#2C#, 16#82#, 16#30#,
      16#09#, 16#DC#, 16#F3#, 16#EB#, 16#18#, 16#F0#, 16#AE#, 16#72#);

   IV1 : constant Byte_Array (0 .. 11) :=
     (16#B5#, 16#57#, 16#9E#, 16#B3#, 16#A2#, 16#25#, 16#45#, 16#84#,
      16#46#, 16#F9#, 16#10#, 16#5D#);

   A1 : constant Byte_Array (0 .. 19) :=
     (16#5D#, 16#06#, 16#DC#, 16#E8#, 16#A1#, 16#B4#, 16#F1#, 16#20#,
      16#2A#, 16#1F#, 16#C2#, 16#B4#, 16#BF#, 16#8A#, 16#BD#, 16#9A#,
      16#A5#, 16#0C#, 16#07#, 16#33#);

   P1 : constant Byte_Array (0 .. 31) :=
     (16#B3#, 16#21#, 16#C8#, 16#16#, 16#BF#, 16#6C#, 16#55#, 16#1C#,
      16#2B#, 16#0F#, 16#DC#, 16#0E#, 16#0C#, 16#0A#, 16#8B#, 16#91#,
      16#68#, 16#EE#, 16#12#, 16#90#, 16#85#, 16#5D#, 16#B3#, 16#50#,
      16#50#, 16#90#, 16#AA#, 16#53#, 16#DB#, 16#1A#, 16#13#, 16#C9#);

   C1 : constant Byte_Array (0 .. 31) :=
     (16#1D#, 16#66#, 16#44#, 16#2F#, 16#7A#, 16#AC#, 16#69#, 16#AF#,
      16#CB#, 16#3E#, 16#02#, 16#E4#, 16#19#, 16#CB#, 16#01#, 16#9A#,
      16#D9#, 16#F3#, 16#78#, 16#45#, 16#F5#, 16#0A#, 16#A5#, 16#C8#,
      16#AC#, 16#E6#, 16#CE#, 16#22#, 16#BB#, 16#CF#, 16#2F#, 16#9C#);

   T1 : constant Byte_Array (0 .. 15) :=
     (16#BE#, 16#87#, 16#57#, 16#6E#, 16#44#, 16#5F#, 16#07#, 16#DD#,
      16#A3#, 16#29#, 16#DF#, 16#F5#, 16#15#, 16#07#, 16#45#, 16#2F#);

   K2 : constant Key_Bytes (0 .. 31) :=
     (16#7F#, 16#DE#, 16#29#, 16#D2#, 16#ED#, 16#15#, 16#A6#, 16#D4#,
      16#52#, 16#FA#, 16#66#, 16#1F#, 16#A5#, 16#D1#, 16#85#, 16#3B#,
      16#45#, 16#FF#, 16#EE#, 16#5E#, 16#0C#, 16#DF#, 16#59#, 16#48#,
      16#19#, 16#9A#, 16#F6#, 16#CB#, 16#E5#, 16#38#, 16#75#, 16#BA#);

   IV2 : constant Byte_Array (0 .. 11) :=
     (16#C2#, 16#93#, 16#11#, 16#BB#, 16#DE#, 16#52#, 16#3D#, 16#72#,
      16#71#, 16#2E#, 16#61#, 16#15#);

   A2 : constant Byte_Array (0 .. 12) :=
     (16#5C#, 16#34#, 16#5A#, 16#9B#, 16#40#, 16#81#, 16#F3#, 16#B2#,
      16#EE#, 16#F6#, 16#41#, 16#5E#, 16#52#);

   P2 : constant Byte_Array (0 .. 31) :=
     (16#B3#, 16#25#, 16#CC#, 16#6B#, 16#BB#, 16#02#, 16#49#, 16#0C#,
      16#3D#, 16#43#, 16#5B#, 16#18#, 16#89#, 16#C3#, 16#5D#, 16#EE#,
      16#9B#, 16#54#, 16#91#, 16#CA#, 16#F0#, 16#16#, 16#71#, 16#EE#,
      16#F7#, 16#07#, 16#E9#, 16#BB#, 16#1C#, 16#DA#, 16#80#, 16#41#);

   C2 : constant Byte_Array (0 .. 31) :=
     (16#CC#, 16#53#, 16#16#, 16#73#, 16#F0#, 16#EB#, 16#2C#, 16#2F#,
      16#4D#, 16#CE#, 16#BF#, 16#72#, 16#6A#, 16#A5#, 16#1D#, 16#07#,
      16#E2#, 16#C1#, 16#CD#, 16#39#, 16#DD#, 16#A5#, 16#79#, 16#CD#,
      16#33#, 16#CB#, 16#78#, 16#C2#, 16#FD#, 16#35#, 16#E3#, 16#D6#);
