...
package body FTP_Print is
   ...
   function Pattern (I : Natural) return Unsigned_8 is (Unsigned_8 (I mod 256));
   ...
   function Verify_Count return Natural is (V_Count);
   function Verify_OK    return Boolean is (V_OK);
