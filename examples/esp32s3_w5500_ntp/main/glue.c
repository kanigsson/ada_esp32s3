/* esp32s3_w5500_ntp: example-specific C natives go here.  The shared bare-boot (bringing
...
typedef int esp32s3_w5500_ntp_no_natives;   /* avoid an empty translation unit */
