/* esp32s3_w5500_dhcp: example-specific C natives go here.  The shared bare-boot (bringing
...
typedef int esp32s3_w5500_dhcp_no_natives;   /* avoid an empty translation unit */
