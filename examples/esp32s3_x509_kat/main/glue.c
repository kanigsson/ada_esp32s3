/* esp32s3_x509_kat: example-specific C natives go here.  The shared bare-boot (bringing
...
typedef int esp32s3_x509_kat_no_natives;   /* avoid an empty translation unit */
