/* esp32s3_x509_verify: example-specific C natives go here.  The shared bare-boot (bringing
...
typedef int esp32s3_x509_verify_no_natives;   /* avoid an empty translation unit */
