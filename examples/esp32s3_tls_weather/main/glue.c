/* esp32s3_tls_hello: example-specific C natives go here.  The shared bare-boot (bringing
...
typedef int esp32s3_tls_hello_no_natives;   /* avoid an empty translation unit */
