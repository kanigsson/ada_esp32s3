...
package body ESP32S3.Ext4.Group_Desc is
   ...
   procedure Read (V : in out Volume.Context; Group : U32; D : out Desc) is
      ...
      --  Assemble a 64-bit block pointer from lo (at Lo_Off) and, when the
      --  descriptor is 64-bit, hi (at Hi_Off).
      function Ptr (Lo_Off, Hi_Off : Natural) return Block_Number is
      ...
      function Cnt (Lo_Off, Hi_Off : Natural) return U32 is
   ...
   procedure Write (V : in out Volume.Context; Group : U32; D : Desc) is
      DSz : constant Natural := V.SB.Desc_Size;
      Blk : Block_Number;
      Off : Natural;
      Raw : Byte_Array (0 .. 63);
