...
package ESP32S3.Ext4.Inode is
   ...
   function Is_Dir     (I : Info) return Boolean is ((I.Mode and 16#F000#) = 16#4000#);
   function Is_Reg     (I : Info) return Boolean is ((I.Mode and 16#F000#) = 16#8000#);
   function Is_Symlink (I : Info) return Boolean is ((I.Mode and 16#F000#) = 16#A000#);

   function Uses_Extents (I : Info) return Boolean is ((I.Flags and EXTENTS_FL) /= 0);
   function Is_Inline    (I : Info) return Boolean is ((I.Flags and INLINE_DATA_FL) /= 0);
