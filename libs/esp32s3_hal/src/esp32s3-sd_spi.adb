...
package body ESP32S3.SD_SPI is
   ...
   function Swap (C : Card; S : ESP32S3.SPI.Session; B : Unsigned_8)
   ...
   function Command (C : Card; S : ESP32S3.SPI.Session;
                     Cmd : Unsigned_8; Arg : Unsigned_32) return Unsigned_8
   is
   ...
   function Card_Arg (C : Card; LBA : Block_Address) return Unsigned_32 is
