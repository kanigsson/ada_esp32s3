...
package ESP32S3_Registers.BB is
   pragma Preelaborate;
   ...
   type BBPD_CTRL_Register is record
      DC_EST_FORCE_PD : Boolean := False;
      DC_EST_FORCE_PU : Boolean := False;
      FFT_FORCE_PD    : Boolean := False;
      FFT_FORCE_PU    : Boolean := False;
      --  unspecified
