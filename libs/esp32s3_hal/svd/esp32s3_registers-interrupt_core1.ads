...
package ESP32S3_Registers.INTERRUPT_CORE1 is
   pragma Preelaborate;
   ...
   subtype APP_MAC_INTR_MAP_MAC_INTR_MAP_Field is ESP32S3_Registers.UInt5;

   --  mac interrupt configuration register
   type APP_MAC_INTR_MAP_Register is record
      --  this register used to map mac interrupt to one of core1's external
      --  interrupt
      MAC_INTR_MAP  : APP_MAC_INTR_MAP_MAC_INTR_MAP_Field := 16#10#;
      --  unspecified
   ...
   for APP_MAC_INTR_MAP_Register use record
   ...
   type MAC_NMI_MAP_Register is record
      ...
      --  interrupt
      MAC_NMI_MAP   : MAC_NMI_MAP_MAC_NMI_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type PWR_INTR_MAP_Register is record
      ...
      --  interrupt
      PWR_INTR_MAP  : PWR_INTR_MAP_PWR_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type BB_INT_MAP_Register is record
      ...
      --  interrupt
      BB_INT_MAP    : BB_INT_MAP_BB_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type BT_MAC_INT_MAP_Register is record
      ...
      --  interrupt
      BT_MAC_INT_MAP : BT_MAC_INT_MAP_BT_MAC_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type BT_BB_INT_MAP_Register is record
      ...
      --  interrupt
      BT_BB_INT_MAP : BT_BB_INT_MAP_BT_BB_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type BT_BB_NMI_MAP_Register is record
      --  this register used to map bb_bt_nmi interrupt to one of core1's
      --  external interrupt
      BT_BB_NMI_MAP : BT_BB_NMI_MAP_BT_BB_NMI_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type RWBT_IRQ_MAP_Register is record
      --  this register used to map rwbt_irq interrupt to one of core1's
      --  external interrupt
      RWBT_IRQ_MAP  : RWBT_IRQ_MAP_RWBT_IRQ_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type RWBLE_IRQ_MAP_Register is record
      ...
      --  external interrupt
      RWBLE_IRQ_MAP : RWBLE_IRQ_MAP_RWBLE_IRQ_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type RWBT_NMI_MAP_Register is record
      --  this register used to map rwbt_nmi interupt to one of core1's
      --  external interrupt
      RWBT_NMI_MAP  : RWBT_NMI_MAP_RWBT_NMI_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type RWBLE_NMI_MAP_Register is record
      --  this register used to map rwble_nmi interrupt to one of core1's
      --  external interrupt
      RWBLE_NMI_MAP : RWBLE_NMI_MAP_RWBLE_NMI_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type I2C_MST_INT_MAP_Register is record
      --  this register used to map i2c_mst interrupt to one of core1's
      --  external interrupt
      I2C_MST_INT_MAP : I2C_MST_INT_MAP_I2C_MST_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31   : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SLC0_INTR_MAP_Register is record
      ...
      --  interrupt
      SLC0_INTR_MAP : SLC0_INTR_MAP_SLC0_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SLC1_INTR_MAP_Register is record
      ...
      --  interrupt
      SLC1_INTR_MAP : SLC1_INTR_MAP_SLC1_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type UHCI0_INTR_MAP_Register is record
      ...
      --  interrupt
      UHCI0_INTR_MAP : UHCI0_INTR_MAP_UHCI0_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type UHCI1_INTR_MAP_Register is record
      ...
      --  interrupt
      UHCI1_INTR_MAP : UHCI1_INTR_MAP_UHCI1_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SPI_INTR_1_MAP_Register is record
      --  this register used to map spi_intr_1 interrupt to one of core1's
      --  external interrupt
      SPI_INTR_1_MAP : SPI_INTR_1_MAP_SPI_INTR_1_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SPI_INTR_2_MAP_Register is record
      --  this register used to map spi_intr_2 interrupt to one of core1's
      --  external interrupt
      SPI_INTR_2_MAP : SPI_INTR_2_MAP_SPI_INTR_2_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SPI_INTR_3_MAP_Register is record
      ...
      --  external interrupt
      SPI_INTR_3_MAP : SPI_INTR_3_MAP_SPI_INTR_3_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SPI_INTR_4_MAP_Register is record
      --  this register used to map spi_intr_4 interrupt to one of core1's
      --  external interrupt
      SPI_INTR_4_MAP : SPI_INTR_4_MAP_SPI_INTR_4_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type LCD_CAM_INT_MAP_Register is record
      --  this register used to map lcd_cam interrupt to one of core1's
      --  external interrupt
      LCD_CAM_INT_MAP : LCD_CAM_INT_MAP_LCD_CAM_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31   : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type I2S0_INT_MAP_Register is record
      ...
      --  interrupt
      I2S0_INT_MAP  : I2S0_INT_MAP_I2S0_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type I2S1_INT_MAP_Register is record
      ...
      --  interrupt
      I2S1_INT_MAP  : I2S1_INT_MAP_I2S1_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type UART_INTR_MAP_Register is record
      ...
      --  interrupt
      UART_INTR_MAP : UART_INTR_MAP_UART_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type UART1_INTR_MAP_Register is record
      ...
      --  interrupt
      UART1_INTR_MAP : UART1_INTR_MAP_UART1_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type UART2_INTR_MAP_Register is record
      ...
      --  interrupt
      UART2_INTR_MAP : UART2_INTR_MAP_UART2_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SDIO_HOST_INTERRUPT_MAP_Register is record
      --  this register used to map sdio_host interrupt to one of core1's
      --  external interrupt
   ...
   type PWM0_INTR_MAP_Register is record
      ...
      --  interrupt
      PWM0_INTR_MAP : PWM0_INTR_MAP_PWM0_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type PWM1_INTR_MAP_Register is record
      ...
      --  interrupt
      PWM1_INTR_MAP : PWM1_INTR_MAP_PWM1_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type PWM2_INTR_MAP_Register is record
      ...
      --  interrupt
      PWM2_INTR_MAP : PWM2_INTR_MAP_PWM2_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type PWM3_INTR_MAP_Register is record
      ...
      --  interrupt
      PWM3_INTR_MAP : PWM3_INTR_MAP_PWM3_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type LEDC_INT_MAP_Register is record
      ...
      --  interrupt
      LEDC_INT_MAP  : LEDC_INT_MAP_LEDC_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type EFUSE_INT_MAP_Register is record
      ...
      --  interrupt
      EFUSE_INT_MAP : EFUSE_INT_MAP_EFUSE_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type CAN_INT_MAP_Register is record
      ...
      --  interrupt
      CAN_INT_MAP   : CAN_INT_MAP_CAN_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type USB_INTR_MAP_Register is record
      ...
      --  interrupt
      USB_INTR_MAP  : USB_INTR_MAP_USB_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type RTC_CORE_INTR_MAP_Register is record
      --  this register used to map rtc_core interrupt to one of core1's
      --  external interrupt
      RTC_CORE_INTR_MAP : RTC_CORE_INTR_MAP_RTC_CORE_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31     : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type RMT_INTR_MAP_Register is record
      ...
      --  interrupt
      RMT_INTR_MAP  : RMT_INTR_MAP_RMT_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type PCNT_INTR_MAP_Register is record
      ...
      --  interrupt
      PCNT_INTR_MAP : PCNT_INTR_MAP_PCNT_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type I2C_EXT0_INTR_MAP_Register is record
      --  this register used to map i2c_ext0 interrupt to one of core1's
      --  external interrupt
      I2C_EXT0_INTR_MAP : I2C_EXT0_INTR_MAP_I2C_EXT0_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31     : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type I2C_EXT1_INTR_MAP_Register is record
      --  this register used to map i2c_ext1 interrupt to one of core1's
      --  external interrupt
      I2C_EXT1_INTR_MAP : I2C_EXT1_INTR_MAP_I2C_EXT1_INTR_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31     : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SPI2_DMA_INT_MAP_Register is record
      --  this register used to map spi2_dma interrupt to one of core1's
      --  external interrupt
      SPI2_DMA_INT_MAP : SPI2_DMA_INT_MAP_SPI2_DMA_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31    : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SPI3_DMA_INT_MAP_Register is record
      --  this register used to map spi3_dma interrupt to one of core1's
      --  external interrupt
      SPI3_DMA_INT_MAP : SPI3_DMA_INT_MAP_SPI3_DMA_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31    : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SPI4_DMA_INT_MAP_Register is record
      ...
      --  external interrupt
      SPI4_DMA_INT_MAP : SPI4_DMA_INT_MAP_SPI4_DMA_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31    : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type WDG_INT_MAP_Register is record
      ...
      --  interrupt
      WDG_INT_MAP   : WDG_INT_MAP_WDG_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type TIMER_INT1_MAP_Register is record
      ...
      --  external interrupt
      TIMER_INT1_MAP : TIMER_INT1_MAP_TIMER_INT1_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type TIMER_INT2_MAP_Register is record
      --  this register used to map timer_int2 interrupt to one of core1's
      --  external interrupt
      TIMER_INT2_MAP : TIMER_INT2_MAP_TIMER_INT2_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type TG_T0_INT_MAP_Register is record
      ...
      --  interrupt
      TG_T0_INT_MAP : TG_T0_INT_MAP_TG_T0_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type TG_T1_INT_MAP_Register is record
      ...
      --  interrupt
      TG_T1_INT_MAP : TG_T1_INT_MAP_TG_T1_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type TG_WDT_INT_MAP_Register is record
      ...
      --  interrupt
      TG_WDT_INT_MAP : TG_WDT_INT_MAP_TG_WDT_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type TG1_T0_INT_MAP_Register is record
      ...
      --  interrupt
      TG1_T0_INT_MAP : TG1_T0_INT_MAP_TG1_T0_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type TG1_T1_INT_MAP_Register is record
      ...
      --  interrupt
      TG1_T1_INT_MAP : TG1_T1_INT_MAP_TG1_T1_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31  : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type TG1_WDT_INT_MAP_Register is record
      ...
      --  external interrupt
      TG1_WDT_INT_MAP : TG1_WDT_INT_MAP_TG1_WDT_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31   : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type CACHE_IA_INT_MAP_Register is record
      --  this register used to map cache_ia interrupt to one of core1's
      --  external interrupt
      CACHE_IA_INT_MAP : CACHE_IA_INT_MAP_CACHE_IA_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31    : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type APB_ADC_INT_MAP_Register is record
      --  this register used to map apb_adc interrupt to one of core1's
      --  external interrupt
      APB_ADC_INT_MAP : APB_ADC_INT_MAP_APB_ADC_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31   : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type DMA_IN_CH0_INT_MAP_Register is record
      --  this register used to map dma_in_ch0 interrupt to one of core1's
      --  external interrupt
   ...
   type DMA_IN_CH1_INT_MAP_Register is record
      --  this register used to map dma_in_ch1 interrupt to one of core1's
      --  external interrupt
   ...
   type DMA_IN_CH2_INT_MAP_Register is record
      --  this register used to map dma_in_ch2 interrupt to one of core1's
      --  external interrupt
   ...
   type DMA_IN_CH3_INT_MAP_Register is record
      --  this register used to map dma_in_ch3 interrupt to one of core1's
      --  external interrupt
   ...
   type DMA_IN_CH4_INT_MAP_Register is record
      --  this register used to map dma_in_ch4 interrupt to one of core1's
      --  external interrupt
   ...
   type RSA_INT_MAP_Register is record
      ...
      --  interrupt
      RSA_INT_MAP   : RSA_INT_MAP_RSA_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type AES_INT_MAP_Register is record
      ...
      --  interrupt
      AES_INT_MAP   : AES_INT_MAP_AES_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SHA_INT_MAP_Register is record
      ...
      --  interrupt
      SHA_INT_MAP   : SHA_INT_MAP_SHA_INT_MAP_Field := 16#10#;
      --  unspecified
      Reserved_5_31 : ESP32S3_Registers.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type USB_DEVICE_INT_MAP_Register is record
      --  this register used to map usb_device interrupt to one of core1's
      --  external interrupt
   ...
   subtype DATE_INTERRUPT_DATE_Field is ESP32S3_Registers.UInt28;

   --  version register
   type DATE_Register is record
      --  version register
      INTERRUPT_DATE : DATE_INTERRUPT_DATE_Field := 16#2012300#;
      --  unspecified
   ...
   for DATE_Register use record
      INTERRUPT_DATE at 0 range 0 .. 27;
   ...
   type INTERRUPT_CORE1_Peripheral is record
      --  mac interrupt configuration register
      APP_MAC_INTR_MAP                             : aliased APP_MAC_INTR_MAP_Register;
      --  mac_nmi interrupt configuration register
      ...
      APP_INTR_STATUS_0                            : aliased ESP32S3_Registers.UInt32;
      --  interrupt status register
      APP_INTR_STATUS_1                            : aliased ESP32S3_Registers.UInt32;
      --  interrupt status register
      APP_INTR_STATUS_2                            : aliased ESP32S3_Registers.UInt32;
      --  interrupt status register
      APP_INTR_STATUS_3                            : aliased ESP32S3_Registers.UInt32;
      --  clock gate register
   ...
   for INTERRUPT_CORE1_Peripheral use record
      APP_MAC_INTR_MAP                             at 16#800# range 0 .. 31;
      MAC_NMI_MAP                                  at 16#804# range 0 .. 31;
      PWR_INTR_MAP                                 at 16#808# range 0 .. 31;
      BB_INT_MAP                                   at 16#80C# range 0 .. 31;
      BT_MAC_INT_MAP                               at 16#810# range 0 .. 31;
      BT_BB_INT_MAP                                at 16#814# range 0 .. 31;
      BT_BB_NMI_MAP                                at 16#818# range 0 .. 31;
      RWBT_IRQ_MAP                                 at 16#81C# range 0 .. 31;
      RWBLE_IRQ_MAP                                at 16#820# range 0 .. 31;
      RWBT_NMI_MAP                                 at 16#824# range 0 .. 31;
      RWBLE_NMI_MAP                                at 16#828# range 0 .. 31;
      I2C_MST_INT_MAP                              at 16#82C# range 0 .. 31;
      SLC0_INTR_MAP                                at 16#830# range 0 .. 31;
      SLC1_INTR_MAP                                at 16#834# range 0 .. 31;
      UHCI0_INTR_MAP                               at 16#838# range 0 .. 31;
      UHCI1_INTR_MAP                               at 16#83C# range 0 .. 31;
      GPIO_INTERRUPT_PRO_MAP                       at 16#840# range 0 .. 31;
      GPIO_INTERRUPT_PRO_NMI_MAP                   at 16#844# range 0 .. 31;
      GPIO_INTERRUPT_APP_MAP                       at 16#848# range 0 .. 31;
      GPIO_INTERRUPT_APP_NMI_MAP                   at 16#84C# range 0 .. 31;
      SPI_INTR_1_MAP                               at 16#850# range 0 .. 31;
      SPI_INTR_2_MAP                               at 16#854# range 0 .. 31;
      SPI_INTR_3_MAP                               at 16#858# range 0 .. 31;
      SPI_INTR_4_MAP                               at 16#85C# range 0 .. 31;
      LCD_CAM_INT_MAP                              at 16#860# range 0 .. 31;
      I2S0_INT_MAP                                 at 16#864# range 0 .. 31;
      I2S1_INT_MAP                                 at 16#868# range 0 .. 31;
      UART_INTR_MAP                                at 16#86C# range 0 .. 31;
      UART1_INTR_MAP                               at 16#870# range 0 .. 31;
      UART2_INTR_MAP                               at 16#874# range 0 .. 31;
      SDIO_HOST_INTERRUPT_MAP                      at 16#878# range 0 .. 31;
      PWM0_INTR_MAP                                at 16#87C# range 0 .. 31;
      PWM1_INTR_MAP                                at 16#880# range 0 .. 31;
      PWM2_INTR_MAP                                at 16#884# range 0 .. 31;
      PWM3_INTR_MAP                                at 16#888# range 0 .. 31;
      LEDC_INT_MAP                                 at 16#88C# range 0 .. 31;
      EFUSE_INT_MAP                                at 16#890# range 0 .. 31;
      CAN_INT_MAP                                  at 16#894# range 0 .. 31;
      USB_INTR_MAP                                 at 16#898# range 0 .. 31;
      RTC_CORE_INTR_MAP                            at 16#89C# range 0 .. 31;
      RMT_INTR_MAP                                 at 16#8A0# range 0 .. 31;
      PCNT_INTR_MAP                                at 16#8A4# range 0 .. 31;
      I2C_EXT0_INTR_MAP                            at 16#8A8# range 0 .. 31;
      I2C_EXT1_INTR_MAP                            at 16#8AC# range 0 .. 31;
      SPI2_DMA_INT_MAP                             at 16#8B0# range 0 .. 31;
      SPI3_DMA_INT_MAP                             at 16#8B4# range 0 .. 31;
      SPI4_DMA_INT_MAP                             at 16#8B8# range 0 .. 31;
      WDG_INT_MAP                                  at 16#8BC# range 0 .. 31;
      TIMER_INT1_MAP                               at 16#8C0# range 0 .. 31;
      TIMER_INT2_MAP                               at 16#8C4# range 0 .. 31;
      TG_T0_INT_MAP                                at 16#8C8# range 0 .. 31;
      TG_T1_INT_MAP                                at 16#8CC# range 0 .. 31;
      TG_WDT_INT_MAP                               at 16#8D0# range 0 .. 31;
      TG1_T0_INT_MAP                               at 16#8D4# range 0 .. 31;
      TG1_T1_INT_MAP                               at 16#8D8# range 0 .. 31;
      TG1_WDT_INT_MAP                              at 16#8DC# range 0 .. 31;
      CACHE_IA_INT_MAP                             at 16#8E0# range 0 .. 31;
      SYSTIMER_TARGET0_INT_MAP                     at 16#8E4# range 0 .. 31;
      SYSTIMER_TARGET1_INT_MAP                     at 16#8E8# range 0 .. 31;
      SYSTIMER_TARGET2_INT_MAP                     at 16#8EC# range 0 .. 31;
      SPI_MEM_REJECT_INTR_MAP                      at 16#8F0# range 0 .. 31;
      DCACHE_PRELOAD_INT_MAP                       at 16#8F4# range 0 .. 31;
      ICACHE_PRELOAD_INT_MAP                       at 16#8F8# range 0 .. 31;
      DCACHE_SYNC_INT_MAP                          at 16#8FC# range 0 .. 31;
      ICACHE_SYNC_INT_MAP                          at 16#900# range 0 .. 31;
      APB_ADC_INT_MAP                              at 16#904# range 0 .. 31;
      DMA_IN_CH0_INT_MAP                           at 16#908# range 0 .. 31;
      DMA_IN_CH1_INT_MAP                           at 16#90C# range 0 .. 31;
      DMA_IN_CH2_INT_MAP                           at 16#910# range 0 .. 31;
      DMA_IN_CH3_INT_MAP                           at 16#914# range 0 .. 31;
      DMA_IN_CH4_INT_MAP                           at 16#918# range 0 .. 31;
      DMA_OUT_CH0_INT_MAP                          at 16#91C# range 0 .. 31;
      DMA_OUT_CH1_INT_MAP                          at 16#920# range 0 .. 31;
      DMA_OUT_CH2_INT_MAP                          at 16#924# range 0 .. 31;
      DMA_OUT_CH3_INT_MAP                          at 16#928# range 0 .. 31;
      DMA_OUT_CH4_INT_MAP                          at 16#92C# range 0 .. 31;
      RSA_INT_MAP                                  at 16#930# range 0 .. 31;
      AES_INT_MAP                                  at 16#934# range 0 .. 31;
      SHA_INT_MAP                                  at 16#938# range 0 .. 31;
      CPU_INTR_FROM_CPU_0_MAP                      at 16#93C# range 0 .. 31;
      CPU_INTR_FROM_CPU_1_MAP                      at 16#940# range 0 .. 31;
      CPU_INTR_FROM_CPU_2_MAP                      at 16#944# range 0 .. 31;
      CPU_INTR_FROM_CPU_3_MAP                      at 16#948# range 0 .. 31;
      ASSIST_DEBUG_INTR_MAP                        at 16#94C# range 0 .. 31;
      DMA_APBPERI_PMS_MONITOR_VIOLATE_INTR_MAP     at 16#950# range 0 .. 31;
      CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP    at 16#954# range 0 .. 31;
      CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR_MAP    at 16#958# range 0 .. 31;
      CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP      at 16#95C# range 0 .. 31;
      CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP at 16#960# range 0 .. 31;
      CORE_1_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP    at 16#964# range 0 .. 31;
      CORE_1_DRAM0_PMS_MONITOR_VIOLATE_INTR_MAP    at 16#968# range 0 .. 31;
      CORE_1_PIF_PMS_MONITOR_VIOLATE_INTR_MAP      at 16#96C# range 0 .. 31;
      CORE_1_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP at 16#970# range 0 .. 31;
      BACKUP_PMS_VIOLATE_INTR_MAP                  at 16#974# range 0 .. 31;
      CACHE_CORE0_ACS_INT_MAP                      at 16#978# range 0 .. 31;
      CACHE_CORE1_ACS_INT_MAP                      at 16#97C# range 0 .. 31;
      USB_DEVICE_INT_MAP                           at 16#980# range 0 .. 31;
      PERI_BACKUP_INT_MAP                          at 16#984# range 0 .. 31;
      DMA_EXTMEM_REJECT_INT_MAP                    at 16#988# range 0 .. 31;
      APP_INTR_STATUS_0                            at 16#98C# range 0 .. 31;
      APP_INTR_STATUS_1                            at 16#990# range 0 .. 31;
      APP_INTR_STATUS_2                            at 16#994# range 0 .. 31;
      APP_INTR_STATUS_3                            at 16#998# range 0 .. 31;
      CLOCK_GATE                                   at 16#99C# range 0 .. 31;
      DATE                                         at 16#FFC# range 0 .. 31;
   end record;

   --  Interrupt Controller (Core 1)
   INTERRUPT_CORE1_Periph : aliased INTERRUPT_CORE1_Peripheral
     with Import, Address => INTERRUPT_CORE1_Base;

end ESP32S3_Registers.INTERRUPT_CORE1;
