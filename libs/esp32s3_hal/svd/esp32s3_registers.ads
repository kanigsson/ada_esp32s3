...
package ESP32S3_Registers is
   ...
   EFUSE_Base : constant System.Address := System'To_Address (16#60007000#);
   ...
   I2C1_Base : constant System.Address := System'To_Address (16#60027000#);
   I2S0_Base : constant System.Address := System'To_Address (16#6000F000#);
   I2S1_Base : constant System.Address := System'To_Address (16#6002D000#);
   INTERRUPT_CORE0_Base : constant System.Address := System'To_Address (16#600C2000#);
   INTERRUPT_CORE1_Base : constant System.Address := System'To_Address (16#600C2000#);
   IO_MUX_Base : constant System.Address := System'To_Address (16#60009000#);
   LCD_CAM_Base : constant System.Address := System'To_Address (16#60041000#);
   LEDC_Base : constant System.Address := System'To_Address (16#60019000#);
   PCNT_Base : constant System.Address := System'To_Address (16#60017000#);
   PERI_BACKUP_Base : constant System.Address := System'To_Address (16#6002A000#);
   MCPWM0_Base : constant System.Address := System'To_Address (16#6001E000#);
   MCPWM1_Base : constant System.Address := System'To_Address (16#6002C000#);
   RMT_Base : constant System.Address := System'To_Address (16#60016000#);
   RNG_Base : constant System.Address := System'To_Address (16#60034F6C#);
   ...
   RTC_I2C_Base : constant System.Address := System'To_Address (16#60008C00#);
   RTC_IO_Base : constant System.Address := System'To_Address (16#60008400#);
   SDHOST_Base : constant System.Address := System'To_Address (16#60028000#);
   SENS_Base : constant System.Address := System'To_Address (16#60008800#);
   ...
   SPI3_Base : constant System.Address := System'To_Address (16#60025000#);
   ...
   UART2_Base : constant System.Address := System'To_Address (16#6002E000#);
   ...
   USB0_Base : constant System.Address := System'To_Address (16#60080000#);
   USB_DEVICE_Base : constant System.Address := System'To_Address (16#60038000#);
   USB_WRAP_Base : constant System.Address := System'To_Address (16#60039000#);
   WCL_Base : constant System.Address := System'To_Address (16#600D0000#);
   XTS_AES_Base : constant System.Address := System'To_Address (16#600CC000#);

end ESP32S3_Registers;
