...
package ESP32S3_Registers.SHA is
   pragma Preelaborate;
   ...
   type DATE_Register is record
      ...
      DATE           : DATE_DATE_Field := 16#20190402#;
      --  unspecified
   ...
   --  Sha H memory which contains intermediate hash or finial hash.
   type H_MEM_Registers is array (0 .. 15) of ESP32S3_Registers.UInt32;

   --  Sha M memory which contains message.

   --  Sha M memory which contains message.
   type M_MEM_Registers is array (0 .. 15) of ESP32S3_Registers.UInt32;
   ...
   type SHA_Peripheral is record
      ...
      T_STRING      : aliased ESP32S3_Registers.UInt32;
      --  SHA 512/t configuration register 1.
