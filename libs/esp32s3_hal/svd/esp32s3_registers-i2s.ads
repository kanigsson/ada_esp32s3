...
package ESP32S3_Registers.I2S is
   pragma Preelaborate;
   ...
   subtype RX_CONF_RX_PCM_CONF_Field is ESP32S3_Registers.UInt2;
   subtype RX_CONF_RX_STOP_MODE_Field is ESP32S3_Registers.UInt2;
   ...
   type RX_CONF_Register is record
      ...
      --  unspecified
      Reserved_4_4          : ESP32S3_Registers.Bit := 16#0#;
      ...
      RX_PDM_SINC_DSR_16_EN : Boolean := False;
      --  unspecified
   ...
   subtype TX_CONF_TX_PCM_CONF_Field is ESP32S3_Registers.UInt2;
   subtype TX_CONF_TX_CHAN_MOD_Field is ESP32S3_Registers.UInt3;
   ...
   type TX_CONF_Register is record
      ...
      --  unspecified
      Reserved_14_14  : ESP32S3_Registers.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_21_23  : ESP32S3_Registers.UInt3 := 16#0#;
   ...
   subtype RX_CONF1_RX_TDM_WS_WIDTH_Field is ESP32S3_Registers.UInt7;
   subtype RX_CONF1_RX_BCK_DIV_NUM_Field is ESP32S3_Registers.UInt6;
   subtype RX_CONF1_RX_BITS_MOD_Field is ESP32S3_Registers.UInt5;
   subtype RX_CONF1_RX_HALF_SAMPLE_BITS_Field is ESP32S3_Registers.UInt6;
   subtype RX_CONF1_RX_TDM_CHAN_BITS_Field is ESP32S3_Registers.UInt5;
   ...
   subtype TX_CONF1_TX_TDM_WS_WIDTH_Field is ESP32S3_Registers.UInt7;
   subtype TX_CONF1_TX_BCK_DIV_NUM_Field is ESP32S3_Registers.UInt6;
   subtype TX_CONF1_TX_BITS_MOD_Field is ESP32S3_Registers.UInt5;
   subtype TX_CONF1_TX_HALF_SAMPLE_BITS_Field is ESP32S3_Registers.UInt6;
   subtype TX_CONF1_TX_TDM_CHAN_BITS_Field is ESP32S3_Registers.UInt5;
   ...
   subtype RX_CLKM_CONF_RX_CLKM_DIV_NUM_Field is ESP32S3_Registers.Byte;
   subtype RX_CLKM_CONF_RX_CLK_SEL_Field is ESP32S3_Registers.UInt2;
   ...
   type RX_CLKM_CONF_Register is record
      ...
      --  unspecified
      Reserved_8_25   : ESP32S3_Registers.UInt18 := 16#0#;
   ...
   subtype TX_CLKM_CONF_TX_CLKM_DIV_NUM_Field is ESP32S3_Registers.Byte;
   subtype TX_CLKM_CONF_TX_CLK_SEL_Field is ESP32S3_Registers.UInt2;
   ...
   subtype RX_CLKM_DIV_CONF_RX_CLKM_DIV_Z_Field is ESP32S3_Registers.UInt9;
   subtype RX_CLKM_DIV_CONF_RX_CLKM_DIV_Y_Field is ESP32S3_Registers.UInt9;
   subtype RX_CLKM_DIV_CONF_RX_CLKM_DIV_X_Field is ESP32S3_Registers.UInt9;
   ...
   subtype TX_CLKM_DIV_CONF_TX_CLKM_DIV_Z_Field is ESP32S3_Registers.UInt9;
   subtype TX_CLKM_DIV_CONF_TX_CLKM_DIV_Y_Field is ESP32S3_Registers.UInt9;
   subtype TX_CLKM_DIV_CONF_TX_CLKM_DIV_X_Field is ESP32S3_Registers.UInt9;
   ...
   subtype TX_PCM2PDM_CONF_TX_PDM_SINC_OSR2_Field is ESP32S3_Registers.UInt4;
   subtype TX_PCM2PDM_CONF_TX_PDM_PRESCALE_Field is ESP32S3_Registers.Byte;
   subtype TX_PCM2PDM_CONF_TX_PDM_HP_IN_SHIFT_Field is ESP32S3_Registers.UInt2;
   subtype TX_PCM2PDM_CONF_TX_PDM_LP_IN_SHIFT_Field is ESP32S3_Registers.UInt2;
   subtype TX_PCM2PDM_CONF_TX_PDM_SINC_IN_SHIFT_Field is
   ...
   subtype TX_PCM2PDM_CONF1_TX_PDM_FP_Field is ESP32S3_Registers.UInt10;
   subtype TX_PCM2PDM_CONF1_TX_PDM_FS_Field is ESP32S3_Registers.UInt10;
   subtype TX_PCM2PDM_CONF1_TX_IIR_HP_MULT12_5_Field is
     ESP32S3_Registers.UInt3;
   subtype TX_PCM2PDM_CONF1_TX_IIR_HP_MULT12_0_Field is
     ESP32S3_Registers.UInt3;
   ...
   subtype RX_TDM_CTRL_RX_TDM_TOT_CHAN_NUM_Field is ESP32S3_Registers.UInt4;
   ...
   subtype TX_TDM_CTRL_TX_TDM_TOT_CHAN_NUM_Field is ESP32S3_Registers.UInt4;
   ...
   subtype RX_TIMING_RX_SD_IN_DM_Field is ESP32S3_Registers.UInt2;
   subtype RX_TIMING_RX_SD1_IN_DM_Field is ESP32S3_Registers.UInt2;
   subtype RX_TIMING_RX_SD2_IN_DM_Field is ESP32S3_Registers.UInt2;
   subtype RX_TIMING_RX_SD3_IN_DM_Field is ESP32S3_Registers.UInt2;
   subtype RX_TIMING_RX_WS_OUT_DM_Field is ESP32S3_Registers.UInt2;
   subtype RX_TIMING_RX_BCK_OUT_DM_Field is ESP32S3_Registers.UInt2;
   subtype RX_TIMING_RX_WS_IN_DM_Field is ESP32S3_Registers.UInt2;
   subtype RX_TIMING_RX_BCK_IN_DM_Field is ESP32S3_Registers.UInt2;
   ...
   type RX_TIMING_Register is record
      ...
      --  unspecified
      Reserved_26_27 : ESP32S3_Registers.UInt2 := 16#0#;
   ...
   subtype TX_TIMING_TX_SD_OUT_DM_Field is ESP32S3_Registers.UInt2;
   subtype TX_TIMING_TX_SD1_OUT_DM_Field is ESP32S3_Registers.UInt2;
   subtype TX_TIMING_TX_WS_OUT_DM_Field is ESP32S3_Registers.UInt2;
   subtype TX_TIMING_TX_BCK_OUT_DM_Field is ESP32S3_Registers.UInt2;
   subtype TX_TIMING_TX_WS_IN_DM_Field is ESP32S3_Registers.UInt2;
   subtype TX_TIMING_TX_BCK_IN_DM_Field is ESP32S3_Registers.UInt2;
   ...
   type TX_TIMING_Register is record
      ...
      --  unspecified
      Reserved_6_15  : ESP32S3_Registers.UInt10 := 16#0#;
   ...
   subtype LC_HUNG_CONF_LC_FIFO_TIMEOUT_Field is ESP32S3_Registers.Byte;
   subtype LC_HUNG_CONF_LC_FIFO_TIMEOUT_SHIFT_Field is ESP32S3_Registers.UInt3;
   ...
   subtype RXEOF_NUM_RX_EOF_NUM_Field is ESP32S3_Registers.UInt12;
   ...
   type DATE_Register is record
      ...
      DATE           : DATE_DATE_Field := 16#2009070#;
      --  unspecified
      Reserved_28_31 : ESP32S3_Registers.UInt4 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type I2S0_Peripheral is record
      ...
      CONF_SIGLE_DATA  : aliased ESP32S3_Registers.UInt32;
      --  I2S TX status register
