...
package ESP32S3_Registers.TWAI is
   pragma Preelaborate;
   ...
   type INT_RAW_Register is record
      ...
      --  unspecified
      Reserved_4_4       : ESP32S3_Registers.Bit;
   ...
   subtype BUS_TIMING_0_BAUD_PRESC_Field is ESP32S3_Registers.UInt14;
   subtype BUS_TIMING_0_SYNC_JUMP_WIDTH_Field is ESP32S3_Registers.UInt2;
   ...
   subtype BUS_TIMING_1_TIME_SEG1_Field is ESP32S3_Registers.UInt4;
   subtype BUS_TIMING_1_TIME_SEG2_Field is ESP32S3_Registers.UInt3;
   ...
   subtype ARB_LOST_CAP_ARB_LOST_CAP_Field is ESP32S3_Registers.UInt5;
   ...
   subtype ERR_CODE_CAP_ECC_SEGMENT_Field is ESP32S3_Registers.UInt5;
   subtype ERR_CODE_CAP_ECC_TYPE_Field is ESP32S3_Registers.UInt2;
   ...
   subtype ERR_WARNING_LIMIT_ERR_WARNING_LIMIT_Field is ESP32S3_Registers.Byte;
   ...
   subtype RX_ERR_CNT_RX_ERR_CNT_Field is ESP32S3_Registers.Byte;
   ...
   subtype TX_ERR_CNT_TX_ERR_CNT_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_0_TX_BYTE_0_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_1_TX_BYTE_1_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_2_TX_BYTE_2_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_3_TX_BYTE_3_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_4_TX_BYTE_4_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_5_TX_BYTE_5_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_6_TX_BYTE_6_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_7_TX_BYTE_7_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_8_TX_BYTE_8_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_9_TX_BYTE_9_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_10_TX_BYTE_10_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_11_TX_BYTE_11_Field is ESP32S3_Registers.Byte;
   ...
   subtype DATA_12_TX_BYTE_12_Field is ESP32S3_Registers.Byte;
   ...
   subtype RX_MESSAGE_CNT_RX_MESSAGE_COUNTER_Field is ESP32S3_Registers.UInt7;
   ...
   subtype CLOCK_DIVIDER_CD_Field is ESP32S3_Registers.Byte;
