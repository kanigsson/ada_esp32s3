...
package ESP32S3_Registers.UART is
   pragma Preelaborate;
   ...
   subtype FIFO_RXFIFO_RD_BYTE_Field is ESP32S3_Registers.Byte;
   ...
   subtype CLKDIV_CLKDIV_Field is ESP32S3_Registers.UInt12;
   subtype CLKDIV_FRAG_Field is ESP32S3_Registers.UInt4;
   ...
   type CLKDIV_Register is record
      ...
      --  unspecified
      Reserved_12_19 : ESP32S3_Registers.Byte := 16#0#;
   ...
   subtype RX_FILT_GLITCH_FILT_Field is ESP32S3_Registers.Byte;
   ...
   subtype STATUS_RXFIFO_CNT_Field is ESP32S3_Registers.UInt10;
   subtype STATUS_TXFIFO_CNT_Field is ESP32S3_Registers.UInt10;
   ...
   type STATUS_Register is record
      ...
      --  unspecified
      Reserved_10_12 : ESP32S3_Registers.UInt3;
      ...
      --  unspecified
      Reserved_26_28 : ESP32S3_Registers.UInt3;
   ...
   subtype CONF0_BIT_NUM_Field is ESP32S3_Registers.UInt2;
   subtype CONF0_STOP_BIT_NUM_Field is ESP32S3_Registers.UInt2;
   ...
   subtype CONF1_RXFIFO_FULL_THRHD_Field is ESP32S3_Registers.UInt10;
   subtype CONF1_TXFIFO_EMPTY_THRHD_Field is ESP32S3_Registers.UInt10;
   ...
   subtype LOWPULSE_MIN_CNT_Field is ESP32S3_Registers.UInt12;
   ...
   subtype HIGHPULSE_MIN_CNT_Field is ESP32S3_Registers.UInt12;
   ...
   subtype RXD_CNT_RXD_EDGE_CNT_Field is ESP32S3_Registers.UInt10;
   ...
   subtype SLEEP_CONF_ACTIVE_THRESHOLD_Field is ESP32S3_Registers.UInt10;
   ...
   subtype SWFC_CONF0_XOFF_THRESHOLD_Field is ESP32S3_Registers.UInt10;
   subtype SWFC_CONF0_XOFF_CHAR_Field is ESP32S3_Registers.Byte;
   ...
   subtype SWFC_CONF1_XON_THRESHOLD_Field is ESP32S3_Registers.UInt10;
   subtype SWFC_CONF1_XON_CHAR_Field is ESP32S3_Registers.Byte;
   ...
   subtype TXBRK_CONF_TX_BRK_NUM_Field is ESP32S3_Registers.Byte;
   ...
   subtype IDLE_CONF_RX_IDLE_THRHD_Field is ESP32S3_Registers.UInt10;
   subtype IDLE_CONF_TX_IDLE_NUM_Field is ESP32S3_Registers.UInt10;
   ...
   subtype RS485_CONF_RS485_TX_DLY_NUM_Field is ESP32S3_Registers.UInt4;
   ...
   subtype AT_CMD_PRECNT_PRE_IDLE_NUM_Field is ESP32S3_Registers.UInt16;
   ...
   subtype AT_CMD_POSTCNT_POST_IDLE_NUM_Field is ESP32S3_Registers.UInt16;
   ...
   subtype AT_CMD_GAPTOUT_RX_GAP_TOUT_Field is ESP32S3_Registers.UInt16;
   ...
   subtype AT_CMD_CHAR_AT_CMD_CHAR_Field is ESP32S3_Registers.Byte;
   subtype AT_CMD_CHAR_CHAR_NUM_Field is ESP32S3_Registers.Byte;
   ...
   subtype MEM_CONF_RX_SIZE_Field is ESP32S3_Registers.UInt3;
   subtype MEM_CONF_TX_SIZE_Field is ESP32S3_Registers.UInt3;
   subtype MEM_CONF_RX_FLOW_THRHD_Field is ESP32S3_Registers.UInt10;
   subtype MEM_CONF_RX_TOUT_THRHD_Field is ESP32S3_Registers.UInt10;
   ...
   subtype MEM_TX_STATUS_APB_TX_WADDR_Field is ESP32S3_Registers.UInt10;
   subtype MEM_TX_STATUS_TX_RADDR_Field is ESP32S3_Registers.UInt10;
   ...
   subtype MEM_RX_STATUS_APB_RX_RADDR_Field is ESP32S3_Registers.UInt10;
   subtype MEM_RX_STATUS_RX_WADDR_Field is ESP32S3_Registers.UInt10;
   ...
   subtype FSM_STATUS_ST_URX_OUT_Field is ESP32S3_Registers.UInt4;
   subtype FSM_STATUS_ST_UTX_OUT_Field is ESP32S3_Registers.UInt4;
   ...
   subtype POSPULSE_POSEDGE_MIN_CNT_Field is ESP32S3_Registers.UInt12;
   ...
   subtype NEGPULSE_NEGEDGE_MIN_CNT_Field is ESP32S3_Registers.UInt12;
   ...
   subtype CLK_CONF_SCLK_DIV_B_Field is ESP32S3_Registers.UInt6;
   subtype CLK_CONF_SCLK_DIV_A_Field is ESP32S3_Registers.UInt6;
   subtype CLK_CONF_SCLK_DIV_NUM_Field is ESP32S3_Registers.Byte;
   subtype CLK_CONF_SCLK_SEL_Field is ESP32S3_Registers.UInt2;
   ...
   subtype ID_ID_Field is ESP32S3_Registers.UInt30;
