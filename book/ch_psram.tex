...
\section{What the octal PSRAM is, and why it is hard}
...
\section{The deterministic part: a fixed register script}
...
\textbf{Step} & \textbf{Register / call} & \textbf{What it does} \\ \hline
\endhead
...
\subsection{The golden cache-phase registers}
...
\textbf{Register} & \textbf{Value} & \textbf{Meaning} \\ \hline
\endhead
...
\section{The non-deterministic part: timing tuning}
...
\subsection{Why IDF's own tuning is a no-op}
