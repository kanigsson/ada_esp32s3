...
\textbf{Example 1 --- a boot counter that survives deep sleep.}
\begin{lstlisting}
...
\textbf{Example 2 --- wake on a button.}
\begin{lstlisting}
with ESP32S3.RTC; use ESP32S3.RTC;
...
\textbf{Example 1 --- hold a relay line high through sleep.}
\begin{lstlisting}
with ESP32S3.GPIO;
...
\textbf{Example 2 --- an RTC pull-up on a wake pin.}
\begin{lstlisting}
with ESP32S3.RTC_IO; use ESP32S3.RTC_IO;
...
\textbf{Example 1 --- read two pads' baselines.}
\begin{lstlisting}
with Ada.Text_IO;   use Ada.Text_IO;
...
\textbf{Example 2 --- detect a finger against a captured baseline.}
\begin{lstlisting}
with Ada.Text_IO;   use Ada.Text_IO;
with ESP32S3.Touch; use ESP32S3.Touch;
...
\textbf{Example 1 --- SHA-256 of a message.}
\begin{lstlisting}
...
\textbf{Example 2 --- SHA-1 (e.g. for a legacy checksum).}
\begin{lstlisting}
with ESP32S3.SHA; use ESP32S3.SHA;
...
\textbf{Example 1 --- AES-128 encrypt then decrypt one block.}
\begin{lstlisting}
...
\textbf{Example 2 --- AES-256 (a 32-byte key selects the cipher automatically).}
\begin{lstlisting}
with ESP32S3.AES; use ESP32S3.AES;
