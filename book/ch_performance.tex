...
is slower than internal SRAM -- fine for a big LISP arena or a filesystem block
cache, not where you want a hot inner loop's working set. And, decisively, \emph{it
