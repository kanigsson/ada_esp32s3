...
\section{\texttt{limited} types: values that cannot be copied}\index{limited types}
...
\section{\texttt{controlled} types and RAII: deterministic teardown}\index{controlled types}\index{RAII}
...
\section{\texttt{protected} types and objects: race-free sharing}\index{protected objects}
...
entity --- no copy, no new object is made. It works for objects, components,
