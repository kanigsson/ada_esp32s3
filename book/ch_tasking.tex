...
\item[\texttt{package body Edge\_Demo is}] begins the implementation of a package
  ...
  to \texttt{end Edge\_Demo;} belongs to it. Because it is a top-level
  (\emph{library-level}) package, the task it declares is legal under the Jorvik
  profile.
...
\begin{center}
\begin{tabular}{l l l}
\textbf{Expected wait} & \textbf{Strategy} & \textbf{Example} \\ \hline
