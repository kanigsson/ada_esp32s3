...
\section{Interactive debugging: OpenOCD + GDB}
...
\section{Editor integration: VS Code and Vim}
...
\section{Post-mortem: decoding a Guru Meditation}
...
\section{The runtime's own diagnostics}
...
\begin{itemize}
  ...
  \item \textbf{A fault safe-state hook.} The \texttt{esp32s3\_safe\_state}
