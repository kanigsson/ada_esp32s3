...
\section{The Xtensa interrupt levels}
...
\textbf{Level} & \textbf{Role on this port} \\ \hline
\endhead
...
\section{Priorities and the masking model}
...
\section{From silicon to handler}
...
\section{Attaching a handler: two axes}
...
\subsection{Axis 1 --- API layer (high level vs low level)}
...
\subsection{Axis 2 --- static vs dynamic (within the high-level layer)}
...
\section{Why the profiles differ}
...
\subsection{The bare-board full \texttt{System.Interrupts}}
...
\section{Exercising the vectors}
