...
GPS module, SD card and LED string that hang off the ESP32-S3's buses. Each
driver layers on one (or two) of the on-chip drivers: the I2C devices ride
\texttt{ESP32S3.I2C}, the display rides \texttt{ESP32S3.SPI}, the codec uses
\texttt{ESP32S3.I2C} for control and \texttt{ESP32S3.I2S} for audio, the GPS
service reads \texttt{ESP32S3.UART}, and the LED string is clocked out over
\texttt{ESP32S3.RMT}.
...
\section{CH422G --- I2C I/O Expander}
...
\section{TCA9555 --- I2C 16-bit I/O Expander}
...
\section{PCF85063A --- I2C Real-Time Clock}
...
\section{SHT41 --- I2C Temperature / Humidity Sensor}
\label{app:ext:sht41}
...
\section{QMI8658C --- I2C 6-Axis IMU}
...
\section{ST7789 --- SPI TFT Display Controller}
...
\section{GPS --- NMEA-0183 Receiver}
\label{app:ext:gps}
...
\section{SD Card (SD\_SPI) --- Removable Storage}
\label{app:ext:sdspi}
...
\section{TX1812 --- Addressable RGB LED String}
