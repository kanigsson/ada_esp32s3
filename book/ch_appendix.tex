...
\label{app:pins}\index{GPIO pins}\index{Pin\_Id}
...
\begin{tabular}{l l}
\toprule
\textbf{Pads} & \textbf{Status} \\ \midrule
...
\label{app:profiles}\index{runtime profile}

\begin{center}
\begin{tabular}{l l l l}
\toprule
\textbf{Feature} & \textbf{light-tasking} & \textbf{embedded} & \textbf{full} \\ \midrule
...
\label{app:examples}\index{example index}
...
\toprule
\textbf{Name} & \textbf{Profile} & \textbf{Shows} \\ \midrule
\endhead
...
\texttt{tlv2556}         & embedded & external SPI 12-bit ADC + ratiometric self-test \\
