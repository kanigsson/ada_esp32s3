...
\label{ch:suspension}\index{suspension object}
...
\section{The interface}\index{Suspend\_Until\_True}
...
\section{The signalling pattern}\index{interrupt-to-task hand-off}
...
\section{Level-triggered, so no lost wake-ups}\index{lost wake-up}
...
\section{One waiter, and only self-suspension}\index{task blocking}
...
\section{Suspension object or protected entry?}\index{protected entry}\index{entry barrier}
...
\section{No timeout of its own}\index{delay until}
