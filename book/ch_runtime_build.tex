...
\section{Three profiles, three \texttt{system.ads}}\index{runtime profiles}
...
\begin{center}
\begin{tabular}{l l}
\textbf{Profile} & \textbf{\texttt{system.ads} variant} \\ \hline
...
\textbf{Patch} & \textbf{What it fixes} \\ \hline
