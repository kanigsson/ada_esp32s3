...
\texttt{eth1} down; routes \texttt{8.8.8.8} out \texttt{eth0}; falls a \texttt{10.0.0.x}
destination back to the default when its specific route (\texttt{eth1}/24) is down;
