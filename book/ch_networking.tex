...
\section{The W5500 and its driver}
\label{ch:net:w5500}
...
\section{What GNAT.Sockets provides}
...
\section{Wiring a driver in: the Net\_Device interface}
...
\section{DNS the portable way, DHCP the chip way}
...
\subsection{\texttt{esp32s3\_w5500} --- TCP echo server}
...
\subsection{\texttt{esp32s3\_w5500\_ntp} --- network time (UDP)}
