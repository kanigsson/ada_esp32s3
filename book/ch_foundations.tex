...
Ada terms that may be unfamiliar to a reader coming from C --- \emph{library-level},
\emph{elaboration}, \emph{aspect}, \emph{protected object} and the like --- are
defined in the Terminology section of the Ada Language Techniques chapter
(\S\ref{sec:terms}).
